...
- [Derivation diabatisation](../derivations/derivations_diabatisation.md)
which details the exact procedure to transform from adiabatic to diabatic representation and how it was motivated
