...
For more detailed exploration on this topic ranging from mathematical formula of residual coupling ([residual coupling](../derivations/derivations_residual_coupling.md)), Michael Baer's discussion surrounding this topic refer to [existence. uniqueness, path dependency and curl conditions](propagation_diabatisation_deepdive/analyticity_unique_existence.md), [topological spin](propagation_diabatisation_deepdive/topological_spin.md), construction of the sub-Hilbert space ([condition for a good sub-Hilbert space](../propagation_diabatisation_deepdive/good_subhilbert_space.md)) and example systems [example systems](../propagation_diabatisation_deepdive/example_system.md). As well as related concepts in split diabatic representations ([split diabatic representation](../derivations/derivations_split_diabatic_representations.md)).



## Brief algorithmic breakdown of propagation diabatisation implemented in quantics (safety checks)
