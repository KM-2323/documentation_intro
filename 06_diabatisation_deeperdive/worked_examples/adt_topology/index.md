---
title: ADT Topology Worked Examples
subsubsection_url: false
---

## Overview

These examples show how loop topology, sign changes, and finite-subspace failures appear in small ADT models.

## Examples

1. [Two-state loop and sign change](two_state_loop_and_sign_change.md)
2. [Three-state sign flips and the topological matrix](three_state_sign_flips_and_D_matrix.md)
